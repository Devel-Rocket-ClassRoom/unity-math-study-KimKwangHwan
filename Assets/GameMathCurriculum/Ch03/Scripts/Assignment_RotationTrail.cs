...
public class Assignment_RotationTrail : MonoBehaviour
{
    ...
    {
        // TODO
        Matrix4x4 orbit = Matrix4x4.TRS(transform.position, Quaternion.Euler(0f, rotationSpeed * Time.time, 0f), Vector3.one);
        
        trailPositions.Add(orbit.MultiplyPoint(new Vector3(armLength, 0f, 0f)));
