...
public class Assignment_GachaSimulator : MonoBehaviour
{
    ...
    private void ExecutePull()
    {
        // TODO
        currentPityCount++;
        currentEffectiveRate = currentPityCount < softPityStart ? baseRate : (baseRate + (1 - baseRate) / (hardPity - softPityStart + 1) * (currentPityCount - softPityStart + 1));
