...
public class Assignment_UIPopup : MonoBehaviour
{
    ...
    private void UpdateAnimation()
    {
        ...
        {
            // TODO
            popupPanel.localScale = Vector3.Slerp(Vector3.zero, Vector3.one, EaseOutBounce(t));
        ...
        {
            // TODO
            popupPanel.localScale = Vector3.Slerp(Vector3.one, Vector3.zero, EaseInBounce(t));
